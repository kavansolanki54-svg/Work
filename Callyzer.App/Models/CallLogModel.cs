...
{
    /// <summary>
    /// Represents a single call log record captured from the device call log.
    ...
    public class CallLogModel
    {
        ...
        /// <summary>The raw device call log ID.</summary>
        [Indexed]
        ...
        /// <summary>The start time of the call.</summary>
        ...
        /// <summary>OS version string (e.g., "14" or "17.5").</summary>
        [MaxLength(20)]
