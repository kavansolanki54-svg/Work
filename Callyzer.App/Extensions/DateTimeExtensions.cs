...
namespace Callyzer.App.Extensions
{
    /// <summary>
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Formats a duration in seconds as a compact string (e.g., "2h 30m").
        /// </summary>
        public static string FormatDurationCompact(long durationSeconds)
        {
            if (durationSeconds <= 0) return "0s";
            var span = TimeSpan.FromSeconds(durationSeconds);
            if (span.TotalHours >= 1)
